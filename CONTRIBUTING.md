# Contributing to dbMigrationLib
...
The [issue tracker](https://github.com/PalomaMobile/android-db-migration/issues) is
...
For a complete look at our labels, see the [project labels page](https://github.com/PalomaMobile/android-db-migration/labels).
